...
namespace BGB.InternetBanking.Api.Controllers
{
    ...
    public class CardController : BaseController
    {
        ...
        public CardController(ICardMovementService cardMovementService)
        {
        ...
        [HttpGet]
        public IActionResult GetScheduledByPeriod(int accountNumber, DateTime startDate, DateTime endDate, int? flagId, int? acquirerId)
        {
            var movements = _cardMovementService.GetScheduledByPeriod(accountNumber, startDate, endDate, flagId, acquirerId);
